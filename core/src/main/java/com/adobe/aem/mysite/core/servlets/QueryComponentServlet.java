...
@SlingServletResourceTypes(
        ...
        extensions = "json")
@ServiceDescription("Query Component Servlet")
public class QueryComponentServlet extends SlingSafeMethodsServlet {
    ...
    protected void doGet(final SlingHttpServletRequest request, final SlingHttpServletResponse response) throws ServletException, IOException {
        ...
        map.put("property.value","mysite/components/servletComponent");
        map.put("p.limit","-1");
        ...
        try {
            ...
            for(Hit hit : hits){
                ...
                pageObject.addProperty("path", pagePath);
